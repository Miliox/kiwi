...
bitflags! {
    ...
    pub struct Channel1SquareWaveControl: u8 {
...
bitflags! {
    ...
    pub struct Channel1FrequencyLowerData: u8 {
        const FREQUENCY_LOWER_8_OF_11_BITS = 0b1111_1111;
    }
}
...
bitflags! {
    ...
    pub struct Channel1FrequencyHigherData: u8 {
        ...
        const FREQUENCY_HIGHER_3_OF_11_BITS = 0b0000_0011;
    }
}
...
bitflags! {
    ...
    pub struct Channel2SquareWaveControl: u8 {
        const SOUND_SEQUENCE_DUTY_MASK   = 0b1100_0000;
        const SOUND_SEQUENCE_LENGTH_MASK = 0b0011_1111;
    }
}
