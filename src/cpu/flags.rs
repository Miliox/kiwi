bitflags! {
    ...
    pub struct Flags: u8 {
        ...
        const ZNHC = 0b1111_0000;
        const ZNH  = 0b1110_0000;
        const ZNC  = 0b1101_0000;
        const ZHC  = 0b1011_0000;
        const ZN   = 0b1100_0000;
        const ZH   = 0b1010_0000;
        const ZC   = 0b1001_0000;

        const NHC  = 0b0111_0000;
        const NH   = 0b0110_0000;
        const NC   = 0b0101_0000;

        const HC   = 0b0011_0000;
